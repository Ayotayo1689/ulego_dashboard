...
export default function Airtime() {
  ...
  const handleRowClick = (id) => {
    ...
    navigate(`/airtime_recharge/details?id=${id}`);
  };
  ...
  useEffect(() => {
    ...
    const fetchCoinData = async () => {
      ...
      const url = 'https://devops-ulego-api.centralus.cloudapp.azure.com:447/api/administration/transactions/airtime';
  ...
  <tr>
   ...
   <div className="table-data">
     ...
     <tr  style={{background:'#D6FFFD', height:"40px", border:"none",borderCollapse:"collapse", fontSize:"14px"}}> 
          ...
          <th style={{textAlign:"start",paddingLeft:"0px"}}>Beneficiary Number</th>
          <th style={{textAlign:"start",paddingLeft:"0px"}}>Status</th>
          <th style={{textAlign:"start",paddingLeft:"0px"}}>Amount</th>
