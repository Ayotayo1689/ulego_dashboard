...
export default function AirtimeDetail() {
  ...
  useEffect(() => {
    ...
    const url = `https://devops-ulego-api.centralus.cloudapp.azure.com:447/api/administration/transactions/airtime/${walletId}`;
