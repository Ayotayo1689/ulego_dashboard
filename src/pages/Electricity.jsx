...
export default function Electricity() {
  ...
  useEffect(() => {
    const fetchCoinData = async () => {
      ...
      const url = 'https://devops-ulego-api.centralus.cloudapp.azure.com:447/api/administration/transactions/electricity';
    ...
    <div class="table-data">
     ...
     <tr  style={{background:'#D6FFFD', height:"40px", border:"none",borderCollapse:"collapse", fontSize:"14px"}}> 
        ...
        {currentItems.map((wallet, index )=> (
          ...
          <td style={{paddingLeft:"0px",marginLeft:"20px"}}>{wallet.reference}</td>
        </tr>
